...
class AppTextStyle {
  static TextStyle getTextStyle(double fontSize, double height, Color color,
      FontWeight fontWeight, String? fontFamily,
      {TextDecoration? textDecoration, Color? decorationColor}) {
    return TextStyle(
        fontSize: fontSize,
        height: height,
        color: color,
  ...
  static TextStyle getRegularStyle(
    ...
    return getTextStyle(fontSize, height ?? 0, color,
        fontWeight ?? AppFontWeight.regular, fontFamily ?? "Cairo",
        textDecoration: textDecoration);
  }
  ...
  static TextStyle getMediumStyle(
      ...
      String? fontFamily}) {
    return getTextStyle(fontSize, height ?? 0, color,
        fontWeight ?? AppFontWeight.medium, "Cairo");
  }
  ...
  static TextStyle getLightStyle(
      ...
      String? fontFamily}) {
    return getTextStyle(fontSize, height ?? 0, color,
        fontWeight ?? AppFontWeight.light, "Cairo");
  }
  ...
  static TextStyle getBoldStyle(
      ...
      TextDecoration? textDecoration}) {
    return getTextStyle(
        fontSize,  height ?? 0,color, fontWeight ?? AppFontWeight.bold, "Cairo",
        textDecoration: textDecoration);
  }
  ...
  static TextStyle getSemiBoldStyle(
      ...
      TextDecoration? textDecoration}) {
    return getTextStyle(
        fontSize,  height ?? 0,color, fontWeight ?? AppFontWeight.semiBold, "Cairo",
        textDecoration: textDecoration);
  }
